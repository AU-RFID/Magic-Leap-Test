...
namespace UnityEngine.XR.OpenXR.Features.MagicLeapSupport
{
    public partial class MagicLeapSystemNotificationsFeature
    {
        internal class NativeBindings : MagicLeapNativeBindings
        {
            ...
            public static extern MLResult.Code MLOpenXRSuppressSystemNotifications(bool suppressNotifications);

            [DllImport(MagicLeapXrProviderNativeBindings.MagicLeapXrProviderDll, CallingConvention = CallingConvention.Cdecl)]
            public static extern MLResult.Code MLOpenXRGetSystemNotificationsProperties(out ulong flags);
